/*______________Things to do (Coovie please add to this as you see fit)_________________*/
# changes names of tables and elements to lower case for easy codeing
# fill in doctors table with 5 made up doctores
# fill in visitor table with 5 made up doctores
# fill in ratings table with 10 ratings two per visitor
# get search history table to work
# modify querys from HW and labs to our project
# make query robust for our database
